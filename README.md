...
Sections are in recommended study order. Topics within each section go foundational → advanced.
...
| [rag-with-eval](demos/rag-with-eval/) | RAG pipeline end-to-end with RAGAS eval baked in | [RAG](topics/05-retrieval-memory/rag.md) · [Embeddings](topics/01-model-inference-core/embeddings.md) · [Chunking strategies](topics/05-retrieval-memory/chunking-strategies.md) · [Vector databases](topics/05-retrieval-memory/vector-databases.md) · [RAGAS](topics/08-evaluation-quality/ragas.md) | 🔴 |
| [guardrail-pipeline](demos/guardrail-pipeline/) | PII redaction + injection detection before LLM call | [Input guardrails](topics/07-safety-governance/input-guardrails.md) · [PII redaction](topics/07-safety-governance/pii-redaction.md) · [Prompt injection](topics/07-safety-governance/prompt-injection.md) · [Output guardrails](topics/07-safety-governance/output-guardrails.md) | 🔴 |
